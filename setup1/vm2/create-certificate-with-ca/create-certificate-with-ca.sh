...
createCertificateForOrg2() {
    ...
    fabric-ca-client enroll -u https://admin:adminpw@localhost:8050 --caname ca.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    
    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-8050-ca-org2-example-com.pem
    ...
    fabric-ca-client register --caname ca.org2.example.com --id.name orderer2 --id.secret orderer2pw --id.type orderer --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    ...
    fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/msp --csr.hosts peer0.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    ...
    fabric-ca-client enroll -u https://peer0:peer0pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls --enrollment.profile tls --csr.hosts peer0.org2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    ...
    fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp --csr.hosts peer1.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    ...
    # ---------------------------------------------------------------------------------------------------------------------------------------
    # Orderer 1
    # mkdir -p ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com

    # echo
    # echo "Generating Orderer2 msp"
    # echo

    # fabric-ca-client enroll -u https://orderer2:orderer2pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem

    # cp ${PWD}/crypto-config/peerOrganizations/org2.example.com/msp/config.yaml ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/msp/config.yaml

    # echo
    # echo "Generating Orderer2 tls"
    # echo

    # fabric-ca-client enroll -u https://orderer2:orderer2pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls --enrollment.profile tls --csr.hosts orderer2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
    
    # cp ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/tlscacerts/* ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/ca.crt
    # cp ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/signcerts/* ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/server.crt
    # cp ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/keystore/* ${PWD}/crypto-config/ordererOrganizations/org2.example.com/orderers/orderer2.example.com/tls/server.key


    # mkdir -p ${PWD}/crypto-config/ordererOrganizations/org1.example.com/orderers/orderer2.example.com/msp/tlscacerts/
    ...
    # cp ${PWD}/crypto-config/ordererOrganizations/org1.example.com/orderers/orderer2.example.com/tls/tlscacerts/*  ${PWD}/crypto-config/ordererOrganizations/org1.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
    # ---------------------------------------------------------------------------------------------------------------------------------------
    # User And Admin

    mkdir -p ${PWD}/crypto-config/peerOrganizations/org2.example.com/users

    echo
    echo "Generating User msp"
    echo

    fabric-ca-client enroll -u https://user1:user1pw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/users/user1@org2.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem

    echo
    echo "Generating Admin msp"
    echo

    fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:8050 --caname ca.org2.example.com -M ${PWD}/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
